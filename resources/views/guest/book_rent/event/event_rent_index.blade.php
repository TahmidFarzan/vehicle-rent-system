                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('event') ? ' has-error' : '' }}">
                               <label for="event" class="col-md-4 control-label"><p>Event</p></label>
                                ...
                                <div class="col-md-6">
                                  {{ Form::select('event',$EventDetail, null, ['placeholder' => 'Enter event','class'=>'form-control','id'=>'event']) }}
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                               <label for="price" class="col-md-4 control-label"><p>Vehicle rent Price</p></label>
         ...
         // Price found
          $(document).on('change','#event',function(){
           $(document).on('change','#vehicle_type',function(){
              ...
              $.ajax({
               type:'get',
                 url:'{!! URL::to('home/event/book/price/found')!!}',
                 data:{'event_id':event_id,'vehicle_type_id':vehicle_type_id},
