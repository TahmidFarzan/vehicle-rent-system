        ...
        <div class="col-lg-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="panel-body">
                         {!! Form::model($User,array('route' => ['user_setting.update',$User->id],'method'=>'PUT','class'=>'form-horizontal','id'=>'Update_user_setting')) !!}
                               {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label for="name" class="col-md-4 control-label"><p>Name</p></label>

                                   <div class="col-md-6">
                                      <input id="name" type="text" class="form-control" name="name" value="{{ $User->name }}" placeholder="Ex: Farzan">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="email" class="form-control" name="email" value="{{ $User->email }}" placeholder="Ex: farzan@email.com">
