            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                   ...
                   <div class="panel panel-default">
                      <div class="panel-heading"><i class="fa fa-edit fa-fw"></i> Home info edit</div>
                      <div class="panel-body">
                        {!! Form::model($HomeDetail,array('route' => ['admin-home_detail.update',$HomeDetail->id],'method'=>'PUT','class'=>'form-horizontal','id'=>'Update_home_form')) !!}
                            {{ csrf_field() }}
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                 <label for="description" class="col-md-2 control-label"><p>Description</p></label>
                                  <div class="col-md-9 my-form-div">
                                     <textarea id="description" name="description" class="form-control textarea" rows="7">{{$HomeDetail->description}}</textarea>
