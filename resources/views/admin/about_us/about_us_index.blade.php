            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                   ...
                   <div class="panel panel-default">
                      <div class="panel-heading"><i class="fa fa-edit fa-fw"></i> About us</div>
                      <div class="panel-body">
                         <form class="form-horizontal" method="POST" name="Add_about_us_form" id="Add_about_us_form" action="{{ route('admin-about_us.store') }}">
                            {{ csrf_field() }}
                  ...
                  <!-- List -->
                    <div class="panel panel-default">
                      <div class="panel-heading"><i class="fa fa-dashboard fa-fw"></i>About us list</div>
                      <div class="panel-body">
                        <div class="table-responsive">
                           <table class="table table-striped table-bordered table-hover">
                             ...
                             <tbody>
                              ...
                              <tr>
                                    <td>{{$about->created_at}}<br/>({{ $about->created_at->diffForHumans() }})</td>
                                    <td><a href="{{route('admin-about_us.show',['id'=>$about->id])}}" class="glyphicon glyphicon-eye-open view-ghost" style=" text-decoration:none;"></a></td>
                                    <td><a href="{{route('admin-about_us.edit',['id'=>$about->id])}}" class="glyphicon glyphicon-pencil edit-ghost" style=" text-decoration:none;"></td>
                                    <td>
                                  ...
                                  {!! Form::open(array('route' => ['admin-about_us.destroy',$about->id],'method'=>'DELETE','class'=>'form-horizontal')) !!}
                              ...
                              {!! $AboutUs->appends(Request::all())->render() !!}
                        </div>
                      </div>   
                    </div>
