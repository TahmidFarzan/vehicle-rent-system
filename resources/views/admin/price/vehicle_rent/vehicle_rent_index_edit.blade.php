                ...
                <div class="col-lg-9">
                  <!-- Add -->
                   <div class="panel panel-default">
                      <div class="panel-heading"><i class="fa fa-edit fa-fw"></i> Vehicle Rent price edit</div>
                      <div class="panel-body">
                         {!! Form::model($VehicleRentPrice,array('route' => ['admin-vehicle_rent_price.update',$VehicleRentPrice->id],'method'=>'PUT','class'=>'form-horizontal','id'=>'Edit_vehicle_price_form')) !!}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('route') ? ' has-error' : '' }}">
                               <label for="route" class="col-md-3 control-label"><p>Route</p></label>
                                ...
                                <div class="col-md-6">
                                   ...
                                   <select class="form-control" id="route" name="route">
                                     ...
                                     @if($route->id==$VehicleRentPrice->route_id)
                                     <option value="{{$route->id}}" selected>{{$route->origin}} - {{$route->destination}}</option>
                                     @else
                              ...
                              <div class="form-group{{ $errors->has('vehicle_type') ? ' has-error' : '' }}">
                               <label for="vehicle_type" class="col-md-3 control-label"><p>Vehicle Type</p></label>
                                ...
                                <div class="col-md-6">
                                   {{ Form::select('vehicle_type',$VehicleType, $VehicleRentPrice->vehicle_type_id, ['placeholder' => 'Please select vehicle type','class'=>'form-control','id'=>'vehicle_type']) }}
                            ...
                            <div class="form-group{{ $errors->has('per_Km_price') ? ' has-error' : '' }}">
                               <label for="per_Km_price" class="col-md-3 control-label"><p>Price(Per Km)</p></label>
                                ...
                                <div class="col-md-6">
                                  <input id="per_Km_price" type="text" class="form-control" name="per_Km_price" value="{{ old('per_Km_price') }}" placeholder="Ex: 100" min="0">
                                  ...
                                  <div class="col-md-2">
                                      <div class="col-md-6 col-md-offset-4">
                                         <a href="javascript: void(0)" onClick="DistancePriceCalculate()" class="btn submit-ghost glyphicon glyphicon-usd" id="Distance_price_calculate">
                                         Total price
                                         </a>
                                      </div>
                                  </div>
                            ...
                            <div class="form-group{{ $errors->has('distance_price') ? ' has-error' : '' }}">
                               <label for="distance_price" class="col-md-3 control-label"><p>Distance price</p></label>
                                ...
                                <div class="col-md-6">
                                  <input id="distance_price" type="number" class="form-control" name="distance_price" value="{{ $VehicleRentPrice->distance_price }}" placeholder="Ex: 100" min="0" readonly>
                             ...
                             <div class="form-group{{ $errors->has('rent_price') ? ' has-error' : '' }}">
                               <label for="rent_price" class="col-md-3 control-label"><p>Rent price</p></label>
                                ...
                                <div class="col-md-6">
                                  <input id="rent_price" type="number" class="form-control" name="rent_price" value="{{ $VehicleRentPrice->rent_price }}" placeholder="Ex: 100" min="0">
                              ...
                              <div class="form-group{{ $errors->has('total_price') ? ' has-error' : '' }}">
                               <label for="total_price" class="col-md-3 control-label"><p>Total Price</p></label>
                                ...
                                <div class="col-md-6">
                                  <input id="total_price" type="number" class="form-control" name="total_price" value="{{ $VehicleRentPrice->total_price }}" placeholder="Ex: 100" min="0" readonly>
...
// Desgine error message
    ...
    // Form validate 
        $('#Edit_vehicle_price_form').validate({
         rules:{
            distance_price:{
              required:true,
              maxlength:10,
